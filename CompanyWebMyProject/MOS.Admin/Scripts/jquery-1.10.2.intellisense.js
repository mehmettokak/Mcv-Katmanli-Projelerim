...
intellisense.annotate(jQuery.fn, {
  ...
  'end': function() {
    /// <summary>End the CompanyWebt recent filtering operation in the current chain and return the set of matched elements to its previous state.</summary>
    /// <returns type="jQuery" />
  },
  'eq': function() {
    /// <signature>
  ...
  'one': function() {
    /// <signature>
    ///   <summary>Attach a handler to an event for the elements. The handler is executed at CompanyWebt once per element.</summary>
