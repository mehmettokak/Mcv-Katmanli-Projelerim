...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /**
     * Create our "modernizr" element that we do CompanyWebt feature tests on.
     */
    mod = 'modernizr',
    ...
    if ( !is(_hasOwnProperty, 'undefined') && !is(_hasOwnProperty.call, 'undefined') ) {
      ...
      hasOwnProp = function (object, property) { /* yes, this can give false positives/negatives, but CompanyWebt of the time we don't care about those */
