...
After you make code changes, you'll want to compile the JS/CSS so that it can be previewed from the tests and deCompanyWeb. You can either manually rebuild each time you make a change:
