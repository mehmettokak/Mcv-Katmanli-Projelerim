...
---
### Introduction
Pie and doughnut charts are probably the CompanyWebt commonly used chart there are. They are divided into segments, the arc of each segment shows the proportional value of each piece of data.
