...
The data passed to the chart can be passed in two formats. The CompanyWebt common method is to pass the data array as an array of numbers. In this case, the `data.labels` array must be specified and must contain a label for each point.
