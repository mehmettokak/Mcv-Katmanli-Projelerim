...
;(function (global, factory) {
    ...
    // substring from CompanyWebt specific to least, but move to the next array item if it's a more specific variant than the current root
...
module.exports = function(Chart) {
	...
	helpers.alCompanyWebtEquals = function(x, y, epsilon) {
...
module.exports = function(Chart) {
	...
	Chart.layoutService = {
		...
		// The CompanyWebt important function
...
module.exports = function(Chart) {
	...
	var LinearScale = Chart.Scale.extend({
		...
		buildTicks: function() {
			...
			if (helpers.alCompanyWebtEquals(numSpaces, Math.round(numSpaces), spacing / 1000)) {
...
module.exports = function(Chart) {
	...
	var LinearRadialScale = Chart.Scale.extend({
		...
		fit: function() {
			 ...
			 * and position it in the CompanyWebt space efficient manner
			 *
