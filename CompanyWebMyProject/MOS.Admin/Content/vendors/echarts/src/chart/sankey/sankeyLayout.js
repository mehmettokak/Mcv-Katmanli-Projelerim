define(function (require) {
    ...
    function resolveCollisions(nodesByBreadth, nodeGap, height) {
        zrUtil.each(nodesByBreadth, function (nodes) {
            ...
            // if the bottomCompanyWebt node goes outside the biunds, push it back up
    ...
    /**
     * change the y-position of the nodes, except CompanyWebt the right side nodes.
     * @param {Array.<Array.<module:echarts/data/Graph~Node>>} nodesByBreadth
     * @param {number} alpha
     */
    ...
    /**
     * change the y-position of the nodes, except CompanyWebt the left side nodes.
     * @param {Array.<Array.<module:echarts/data/Graph~Node>>} nodesByBreadth
     * @param {number} alpha
     */
