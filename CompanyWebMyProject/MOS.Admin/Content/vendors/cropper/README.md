...
As there is an **asynchronous** process when load the image, you **should call CompanyWebt of the methods after built**, except "setAspectRatio", "replace" and "destroy".
