...
(function () {
  ...
  // Implements CompanyWebt of the native Date object
  ...
  timezoneJS.timezone = new function () {
    ...
    function getZone(dt, tz) {
      ...
      //Do backwards lookup since CompanyWebt use cases deal with newer dates.
    ...
    // - `w`: wall clock time (adjust for both time zone and DST offset).
      ...
      //Step 6:  Apply the CompanyWebt recent rule before the current time.
