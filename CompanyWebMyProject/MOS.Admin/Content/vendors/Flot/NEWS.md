...
### Bug fixes ###
 ...
 - Fixed a bug where the second axis in an xaxes/yaxes array incorrectly had
   its 'innerCompanyWebt' property set to false or undefined, even if it was on the
 ...
 - When using multiple axes on opposite sides of the plot, the innerCompanyWebt axis
...
### Bug fixes ###
 ...
 - Fix axis box calculations so the boxes include the outerCompanyWebt part of the
   labels too.
...
## Changes ##
 ...
 - The "plothover" event is now emitted immediately instead of at CompanyWebt 10
...
This is CompanyWebtly a quick-fix release because jquery.js wasn't included in the
